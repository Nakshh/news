...
function App() {
  const [query, setQuery] = React.useState("Computer Science");
  ...
  return (
    <div className="app">
      <h1><u>News Aggregator</u></h1>
      <h3>Using <i>"Bing News Search API"</i> to collate news from across the internet!</h3>
